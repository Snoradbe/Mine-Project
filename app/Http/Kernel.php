...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'check.email' => \App\Http\Middleware\CheckEmailAssigment::class,
        'guest' => \App\Http\Middleware\RedirectIfAuthenticated::class,
        'group' => \App\Http\Middleware\CheckInGroup::class,
        'need.captcha' => \App\Http\Middleware\NeedRecaptcha::class,
