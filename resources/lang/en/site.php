        ...
        'windows' => [
            ...
            'password' => [
                'restore' => [
                    ...
                    'subtitle' => 'Enter the email address was associated with the account for which you want to restore password.',
                    'form' => [
                        'email' => 'Email address',
                        'button' => 'Enter'
                    ],
					...
					'verify' => [
						'text' => 'We sent an email with a link to reset the password to the specified email. Check your Inbox and follow instructions in our letter.',
						'sent' => 'Sent to ',
					],
                ],
                'reset' => [
