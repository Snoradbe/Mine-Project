<template>
    <div class="modal store-modal" id="buy-modal" style="display: block" @click.self="$emit('close')">
        <div class="modal__dialog" @click.self="$emit('close')">
            <div class="store-modal__container">
                <div class="modal__body">
                    <div class="store-modal__left">
                        ...
                        <div class="store-modal__info">
                            <div class="store-modal__desc">
								<div class="store-modal__desc-content" v-html="getColumnLangValue('descr', item)" v-if="getColumnLangValue('descr', item)"></div>
							</div>
                            <div class="store-modal__tags">
                                <h5 class="store-modal__tags-title">{{Lang.store.modal.product.tags}}</h5>
                                <p class="store-modal__tag">{{Lang.store.modal.product.type}}: {{getColumnLangValue('name', item.category)}}</p>
                                <p class="store-modal__tag" v-if="item.servername">{{Lang.store.modal.product.server}}: {{item.servername}}</p>
                                <p class="store-modal__tag">{{Lang.store.modal.product.cur}}: {{item.price_rub ? Lang.store.cur.rub : Lang.store.cur.coins}}</p>
                            </div>
                        </div>
                    ...
                    <div class="store-modal__right store-product__picture">
